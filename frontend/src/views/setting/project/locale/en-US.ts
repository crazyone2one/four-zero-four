export default {
  ...
  'system.project.num': 'Project num',
  ...
  'system.project.projectNumPlaceholder':
      'Please enter the project num, which cannot be duplicated with other project nums',
  ...
  'system.project.projectNumRequired': 'Project num cannot be empty',
