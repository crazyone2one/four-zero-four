...
public class OperationHistoryController {
    ...
    public boolean remove(@PathVariable @Parameter(description="变更记录主键") Long id) {
    ...
    public OperationHistory getInfo(@PathVariable @Parameter(description="变更记录主键") Long id) {
